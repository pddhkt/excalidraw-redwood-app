...
// Interactive demo with state management and error simulation
export const InteractiveDemo: Story = {
  render: () => {
    ...
    const [checkResult, setCheckResult] = React.useState<'changes' | 'no-changes' | null>(null);
      ...
      <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
        ...
        >
          <h2 style={{ margin: '0 0 12px 0', fontSize: '18px' }}>
            Interactive Auto-Save Demo with Change Detection
          </h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', fontSize: '14px' }}>
            ...
            <div>
              <strong>Next Check:</strong> {countdown}s
            </div>
            <div>
              ...
              <span style={{
                color: saveStatus === 'saved' ? 'green' :
                       ...
                       saveStatus === 'checking' ? 'gray' :
                       saveStatus === 'no-changes' ? 'gray' :
                       saveStatus === 'error' ? 'red' : 'black',
                fontWeight: 'bold'
              }}>
                {saveStatus}
              </span>
